...
def get_command_line_parser():
    ...
    parser.add_argument('--qry_expansion', type=int, default=3)
    parser.add_argument('--spt_expansion', type=int, default=3)
    parser.add_argument('--model_path', type=str)
    parser.add_argument('--aug_type', type=str, choices=['image_translator', \
        'crop+rotate', 'true-test', 'color', 'affine', 'sim-mix-up'], default=None)
